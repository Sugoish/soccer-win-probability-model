...
[StatsBomb open data](https://github.com/statsbomb/open-data) provides free, real, event-level data (~3,600 events per match: every pass, shot, card, and substitution, each with `statsbomb_xg` for shots) for the entire 2022 FIFA World Cup, 64 matches.
